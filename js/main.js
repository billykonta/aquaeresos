document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            "menu-desc-food-sandwich": "ham, cheese, lettuce, tomato, mayo.",
            "menu-item-food-chicken-sandwich": "Chicken Sandwich",
            "menu-desc-food-chicken-sandwich": "cheese, lettuce, tomato, mayo, chicken nuggets.",
            "menu-item-food-toast": "Toast",
            "menu-desc-food-toast": "",
            "menu-item-food-club-sandwich": "Club Sandwich",
            "menu-desc-food-club-sandwich": "ham, cheese, lettuce, tomato, mayo.",
            "menu-item-food-chicken-club-sandwich": "Chicken Club Sandwich",
            "menu-desc-food-chicken-club-sandwich": "cheese, lettuce, tomato, mayo, chicken nuggets.",
            "menu-item-food-chicken-tortilla": "Chicken Tortilla",
            "menu-desc-food-chicken-tortilla": "cheese, lettuce, tomato, sauce, chicken nuggets.",
            ...
            "menu-desc-food-crepe": "ham, cheese, lettuce, tomato, mayo.",
            "menu-item-food-chicken-crepe": "Chicken Crepe",
            "menu-desc-food-chicken-crepe": "ham, cheese, lettuce, tomato, mayo, chicken nuggets.",
            "menu-item-food-sausage-crepe": "Sausage Crepe",
            "menu-desc-food-sausage-crepe": "cheese, sauce, tomato, lettuce, sausage.",
            "menu-item-food-sweet-crepe": "Sweet Crepe",
